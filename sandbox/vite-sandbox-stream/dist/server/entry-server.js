...
function getNode(jsxElement) {
  ...
  if (typeof jsxElement === "string" || typeof jsxElement === "number") {
    const { currentNode } = ssrDomWalker();
...
function renderChildren$1(parentNode, children) {
  const cleanups = [];
...
function h$1(type, props = {}, children, key) {
  ...
  renderChildren$1(element, children);
...
const getCurrentStream = () => {
  globalThis.__stream_context ?? (globalThis.__stream_context = {});
...
const jsx$1 = (type, { children, ...props } = {}, key) => {
...
function loop(items) {
  return {
    each(children) {
      ...
      return jsx$1(Loop, { each, children });
    }
  };
}
function Loop({
...
function resource(fetcher, _params) {
  ...
  const refetch = () => {
    ...
    if (!isServerStreaming && !isServer$1 && window.__resource && window.__resource[id]) {
      untrack(() => {
...
const DropdownList = ({
  ...
  return () => /* @__PURE__ */ jsx("div", {
    ...
    children: () => dropdowns.numbers.map((number) => /* @__PURE__ */ jsx(Dropdown, {
      number: () => number
    }, () => number))
  });
};
...
const LazyImport = lazy(() => import("./assets/LazyImport-BvwL35l9.js"), "LazyImport");
const LazyTest = lazy(() => import("./assets/Test-CfjTshWv.js"), "Test");
const Lazy = () => {
  return () => /* @__PURE__ */ jsx(Template, {
    title: () => "Lazy",
    children: () => /* @__PURE__ */ jsx("div", {
