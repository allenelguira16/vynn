...
const D = () => globalThis.__stream_context, T = /* @__PURE__ */ new Map(), de = { suspenseID: 0, resourceID: 0, lazyID: 0, stateID: 0, memo: /* @__PURE__ */ new Map() }, h$1 = () => {
  const e = D();
  T.has(e) || T.set(e, de);
  const n = T.get(e);
...
const W = () => globalThis.isServerStreaming;
let S = [], g$2 = 0;
function v() {
...
function ee(e, n) {
  ...
  let o = t.get(n);
  o || (o = /* @__PURE__ */ new Set(), t.set(n, o)), o.has(p) || (o.add(p), p.deps ? p.deps.push(o) : p.deps = [o]);
}
function te(e, n) {
  const t = q.get(e);
  if (!t) return;
...
function Le({ children: e, fallback: n = () => null }) {
  const t = h$1(), o = t.suspenseID++, { controller: r2, encoder: s, end: i, start: c } = D(), a = (f) => {
    c(), f.then(() => {
      const u2 = w$1(e), d = `<template async-id="${o}">${u2}</template>`, l2 = `<script>__hydrateAsync("${o}");document.currentScript.remove();<\/script>`;
      r2.enqueue(s.encode(d)), r2.enqueue(s.encode(l2)), i();
    }).catch((u2) => {
      if (u2 instanceof Promise) c(), a(u2);
      else throw i(), u2;
    });
  };
  try {
...
function se(e) {
  ...
  const o = h$1(), r2 = o.suspenseID++, s = !!window.__SUSPENSE_DEFAULT_FALLBACK__[r2], i = x(s ? n : t);
  function c(a) {
    N$1.pop(), queueMicrotask(() => {
      i.value = "__fromLazy" in a ? () => null : n;
    }), a.then(() => {
      i.value = t;
    });
  }
  return !y && window.__SSR_STREAMING_APP__ ? i.value = t : ce(() => {
    i.value = t;
  }), () => (N$1.push(c), i.value);
}
function ce(e) {
  ...
  for (const r2 of Q(U(n))) {
    ...
    const f = Ae(), u2 = C$1(() => {
      try {
        ...
        if (i.push(() => a && J(a)), i.push(() => a && a.remove()), L(l2)) a && (e.removeChild(a), a = null);
...
function z(e, n, t) {
  ...
  $$2(o);
  const r2 = R(`root-${e.name}`, true), s = X(() => e(t ? { ...n, children: t } : n)), i = U([r2, s]).flat();
  return $$2(null), Ee(r2, o), B.add(r2), i;
}
...
function De(e, n) {
  ...
  for (const o in n) {
    const r2 = () => {
      ...
      const s = C$1(() => {
        const i = n[o], c = typeof i == "function" && o !== "ref" ? i() : i;
...
function le(e, n = {}, t) {
  ...
  o.appendChild(r2);
  const s = E$1(o, t, r2), i = De(o, n);
  return queueMicrotask(() => {
    if (!o.parentNode) return;
    const c = new MutationObserver((a) => {
      for (const f of a) for (const u2 of f.removedNodes) o.isSameNode(u2) && (s(), i(), c.disconnect());
    });
...
function ke(e) {
  ...
  if (n instanceof Element && true) {
    if (console.log(n, e), n.tagName.toLowerCase() !== e) throw new Error("Hydration mismatch because the initial UI does not match what was rendered on the server");
    return t(), n;
  }
...
function Ie(e, n) {
  ...
  return () => {
    ...
    for (let u2 = 0; u2 < r2; u2++) {
      const d = o[u2], l2 = i.get(d);
      if (l2 && l2.length) {
        const m2 = l2.shift();
        c[u2] = m2, s[u2] = t[m2];
      } else {
        const m2 = x(u2), me = n(d, m2);
        s[u2] = { value: d, index: m2, element: me };
      }
    }
    const a = He(c);
    let f = a.length - 1;
    for (let u2 = r2 - 1; u2 >= 0; u2--) {
      const d = s[u2];
      if (c[u2] === -1 || u2 !== a[f]) {
        const l2 = u2 + 1 < r2 ? s[u2 + 1].element : null;
        (_a = d.element.parentNode) == null ? void 0 : _a.insertBefore(d.element, l2);
      } else f--;
      d.index.value = u2;
    }
    return t = s, t.map((u2) => u2.element);
  };
}
function He(e) {
  const n = e.slice(), t = [];
...
const g$1 = /* @__PURE__ */ new Set(["area", "base", "br", "col", "embed", "hr", "img", "input", "link", "meta", "param", "source", "track", "wbr"]);
function b(n, e = {}, t) {
...
const LazyImport = M(() => import("./assets/LazyImport-CzldBov1.js"), "LazyImport");
const LazyTest = M(() => import("./assets/Test-C3adHtbl.js"), "Test");
const Lazy = () => {
  return () => /* @__PURE__ */ m(Template, {
    title: () => "Lazy",
    children: () => /* @__PURE__ */ m("div", {
